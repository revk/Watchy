...
const uint8_t features[] = {    // from https://github.com/sqfmi/Watchy/blob/master/src/bma423.c
   0x5E, 0x80, 0x2e, 0xfc, 0x00, 0x80, 0x2e, 0xfe, 0x00, 0xc8, 0x2e, 0x00, 0x2e,
...
acc_init (void)
{
   ...
   if(status!=1)ESP_LOGE (TAG, "Status %02X", status);
}
